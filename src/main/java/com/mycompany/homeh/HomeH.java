 ...
 */
public class HomeH extends javax.swing.JFrame {

    /**
     * Creates new form HomeH
     */
    public HomeH() {
        super("Início");
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
